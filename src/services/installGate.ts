 ...
 *
 * **🔴 本门只管手动路径（E6#79 更正）**：门的两侧只有「用户此刻点了安装 / 更新」这一种情形。后台自动更新
 * 走**另一条路**、不过本门——勾选「自动更新」本身就是那条路的那次授权（见 updateDiscovery 头注 E6#79 推翻
 * 经过）。#71k 曾把「自动更新弹不出卡」推成「故自动更新整体暂停」，**那条推论不是用户的意思**，已推翻。
 *
